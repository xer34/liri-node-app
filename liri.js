    ...
    .then(function(inquirerResponse) {
      ...
      spotify
        ...
        .then(function(response) {
          console.log(inquirerResponse.trackname + " was perofmed by " + response.tracks.items[0].album.artists[0].name);
          console.log("The album name is " + response.tracks.items[0].album.name)
          console.log("You can preview the track here: " + response.tracks.items[0].preview_url)
    ...
    .then(function(inquirerResponse) {
      ...
      omdb
        ...
        .then(function(response) {
          ...
          .then(function(response) {
            console.log("It got a " + response.Ratings[1].Value + " on Rotten Tomatoes and a " + response.Ratings[0].Value + " on IMDB")
            console.log("The movie was produced in " + response.Country)
            console.log("The plot goes something like this: " + response.Plot)
